...
export default function BottomNav({ currentPath }: { currentPath?: string }) {
  ...
  const tabs: NavTab[] = [
    { href: "/overview", label: "Home", iconName: "Home" },
    { href: "/activity", label: "Activity", iconName: "Activity", badge: reviewCount > 0 ? reviewCount : undefined },
    { href: "/insights", label: "Insights", iconName: "TrendingUp" },
