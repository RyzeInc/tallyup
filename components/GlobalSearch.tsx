...
const pages = [
  ...
  { href: "/review", label: "Review Queue", icon: Lucide.ClipboardCheck, keywords: ["inbox", "needs review", "uncategorized"] },
  { href: "/auto-sort", label: "Auto-Sort", icon: Lucide.Wand2, keywords: ["rules", "categorize", "automation"] },
