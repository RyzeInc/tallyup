...
export default function RulesPage() {
  ...
  const tabs: { key: Tab; label: string; icon: typeof Lucide.Tag }[] = [
    { key: "category", label: "Category Rules", icon: Lucide.Tag },
    { key: "merchant", label: "Merchant Rules", icon: Lucide.Store },
  ];
    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: "var(--background)" }}>
      <SignedIn>
        ...
        <div className="px-4 mb-4">
          <div className="flex gap-2 p-1 rounded-xl" style={{ backgroundColor: "var(--surface-2)" }}>
            {tabs.map((tab) => {
              const Icon = tab.icon;
